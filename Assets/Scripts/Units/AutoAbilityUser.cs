...
namespace StrategyCore
{
    ...
    public class AutoAbilityUser : MonoBehaviour
    {
        ...
        private bool TryCastEntry(int entry)
        {
            ...
            // ВЛАСТЬ У ЯДРА: с 2026-09-09 тот же гейт стоит в Unit.UseAbilityItem — по сети эта проверка
            // обходилась. Здесь строка ОСТАВЛЕНА сознательно как дешёвый отсев ДО поиска цели: без неё
            // AutoCastReady перебирал бы кандидатов на каждом тике у каждого носителя впустую.
