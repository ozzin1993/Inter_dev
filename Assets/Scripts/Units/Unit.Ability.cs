...
namespace StrategyCore
{
    ...
    public partial class Unit
    {
        ...
        public bool UseAbilityItem(int abilityIndex, bool isItem, Unit unit, Vector3 location, bool issuedByPlayer = false)
        {
            ...
            // [Interflow 2026-09-18, решение Artsiom 50] Полёт от отброса закрывает применение умения
            // так же, как немота выше. Своей проверки бы не понадобилось — служебное состояние «в полёте»
            // несёт немоту галкой ассета, и её достаточно, — но флаг читается ЗДЕСЬ намеренно:
            // содержимое ассета — контент, а «летящий не кастует» — правило (решение 50), и оно не должно
            // отваливаться от снятой галки. Команда отбрасывается, а не запоминается, как у оглушения.
