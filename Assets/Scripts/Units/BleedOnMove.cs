...
namespace StrategyCore
{
    ...
    public class BleedOnMove : MonoBehaviour
    {
        ...
        public static void Apply(Unit target, Unit byUnit, int byOwner, DamageType type, float damagePerMeterMoved, float duration)
        {
            ...
            bleed.Init(target, byUnit, byOwner, type, damagePerMeterMoved, duration);
        }

        void Init(Unit target, Unit byUnit, int byOwner, DamageType type, float damagePerMeterMoved, float duration)
        {
            unit = target;
            source = byUnit;
            sourceOwner = byOwner;
