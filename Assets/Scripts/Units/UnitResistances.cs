...
namespace StrategyCore
{
    ...
    public class UnitResistances : MonoBehaviour
    {
        ...
        /// ВРЕМЯ наложения, у числовых категорий (замедления, периодический урон, снижение урона) — СИЛУ
        /// (каталог категорий, решение Artsiom 30.08.2026). Единственное место, где вид категории задан.
        ///
        /// [Interflow 2026-09-17, решение Artsiom 43] Дописанная категория «снижение урона» — ЧИСЛОВАЯ:
        /// своего <c>case</c> ей не нужно, её забирает ветка по умолчанию. Перечислять числовые категории
        /// явным списком нельзя: тогда каждая новая категория молча уезжала бы в «режет время».
        /// </summary>
