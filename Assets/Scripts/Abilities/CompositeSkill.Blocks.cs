...
namespace StrategyCore
{
    ...
    public class SkillSelfCostBlock
    {
        ...
        [Tooltip("Запретить каст, если стоимость добьёт кастера. ВЫКЛ — кастер может убить себя способностью.")]
    ...
    {
        [Tooltip("Включить блок: скилл наносит разовый урон.")]
        public bool enabled;
    ...
    {
        [Tooltip("Включить блок: скилл вешает штатные состояния контроля.")]
        public bool enabled;
    ...
    {
        [Tooltip("Включить блок: скилл призывает юнитов.")]
        public bool enabled;
    ...
    {
        [Tooltip("Включить блок: скилл выставляет зону на землю.")]
        public bool enabled;

        [Tooltip("Префаб зоны. Обязан нести компонент GroundDamageZone — радиус, урон и эффекторы настраиваются на самом префабе.")]
    ...
    {
        [Tooltip("Включить блок: скилл запускает серверный сервис матча.")]
        public bool enabled;
