...
namespace StrategyCore
{
    ...
    public partial class MatchManager
    {
        ...
        /// Ждёт gameOn (как WaveLoop) — до старта клиенту нечего показывать. Запускается из Start()
        /// (только сервер). Клиент, построивший интерфейс ПОЗЖЕ этого момента, стартовую подсветку отсюда
        /// не получит — режимы всех рядов досылаются ему отдельно (Б11: MatchManager.ResendMatchStateTo).
        /// </summary>
