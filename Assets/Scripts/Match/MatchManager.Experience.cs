...
namespace StrategyCore
{
    ...
    public partial class MatchManager
    {
        ...
        // приходит готовым (ApplyTeamExperience). Подключение в середине матча НЕ покрыто — как и у уровня ГЗ.
        ...
        /// Клиенту, подключившемуся в середине матча, состояние не досылается — это отдельный блок (поздний вход).
        /// </summary>
        ...
        /// <summary>
        /// Серверная корутина: опыт за владение центральной точкой. Ждёт старта матча (как PassiveIncomeLoop),
