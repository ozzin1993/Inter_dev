...
namespace StrategyCore
{
    ...
    public class Research : Ability
    {
        ...
        public override void Use(Unit castingUnit, int castingPlayer, int level)
        {
            ...
            UIManager.instance.ShowNotifyMsg("Research " + unlockTech[level].displayName + " completed!", castingUnit.owner, false);
            if (ReferenceManager.instance.researchComplete != null) SoundFXManager.instance.PlaySoundClip(ReferenceManager.instance.researchComplete, 1, SoundFXManager.instance.voiceGroup);
        }
    }
}
