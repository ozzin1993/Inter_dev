    ...
    public class ConstructionUnit : MonoBehaviour
    {
        ...
        public void UpgradeBuilding(Unit upgradeUnit, float time, ResourceWrapper[] cost)
        {
            ...
            else
            {
                ...
                // ReSelect
                if (PlayerControl.instance.activeUnit == thisUnit) PlayerControl.instance.AddToSelection(thisUnit, true, true);
            }
        }
        ...
        public void ConstructionPositionReached()
        {
            ...
            {
                UIManager.instance.ShowNotifyMsg("Can't build there.", thisUnit.owner, true);
        ...
        public void FinishConstruction()
        {
            if (upgradeBuildingRef)
            {
                ...
                bool wasSelected = PlayerControl.instance.activeUnit == thisUnit;
                ...
                // Add to selection
                if (wasSelected) PlayerControl.instance.AddToSelection(upgradedUnit, true, true);
                ...
                // Play upgrade sound
                if (ReferenceManager.instance.upgradeComplete != null) SoundFXManager.instance.PlaySoundClip(ReferenceManager.instance.upgradeComplete, 1, SoundFXManager.instance.voiceGroup);
            }
            else
            {
                // Finished construction
                ...
                // Add to selection
                if (PlayerControl.instance.activeUnit == buildingObj) PlayerControl.instance.AddToSelection(buildingObj, true, true);

                // Play construction complete sound
                if (ReferenceManager.instance.buildingComplete != null) SoundFXManager.instance.PlaySoundClip(ReferenceManager.instance.buildingComplete, 1, SoundFXManager.instance.voiceGroup);
            }
        }
