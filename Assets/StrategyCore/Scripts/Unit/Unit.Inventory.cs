    ...
    public partial class Unit
    {
        ...
        public void BuyItem(int abilityIndex, Unit shoppingUnit = null)
        {
            ...
            if (shoppingUnit == null || Vector2.Distance(new Vector2(shoppingUnit.transform.position.x, shoppingUnit.transform.position.z), new Vector2(transform.position.x, transform.position.z)) > GameManager.instance.shopRadius)
            {
                ...
                {
                    UIManager.instance.ShowNotifyMsg("No unit nearby to buy this item", SlotManager.instance.currentPlayer, false);
                    return;
                }
            }
            ...
            {
                // No available slots
                UIManager.instance.ShowNotifyMsg("No slots are available", shoppingUnit.owner, true);
                return;
            }
            else
            {
        ...
        public bool SellItem(int itemIndex)
        {
            ...
            UIManager.instance.ShowNotifyMsg("No shops nearby. Shopping radius is " + GameManager.instance.shopRadius + " meters.", owner, true);
            return false;
        }
        ...
        public bool DropItem(int itemIndex)
        {
            ...
            if (items[itemIndex] != null)
            {
                ...
                else UIManager.instance.ShowNotifyMsg("Can`t drop item here", owner, true);
            }
            return false;
        }
        ...
        public void DropItem(int itemIndex, Unit unit)
        {
            ...
            else UIManager.instance.ShowNotifyMsg("This unit can`t accept the item!", owner, false);
        }
        ...
        public void DropItemPointReached()
        {
            if (items[dropItemIndex] != null)
            {
                ...
                else UIManager.instance.ShowNotifyMsg("Can`t drop item there!", owner, true);
            }
        ...
        public void DropItemUnitReached()
        {
            if (items[dropItemIndex] != null)
            {
                ...
                else UIManager.instance.ShowNotifyMsg("This unit can`t accept the item!", owner, true);
            }
            CancelDropItemMove(false);
        }
