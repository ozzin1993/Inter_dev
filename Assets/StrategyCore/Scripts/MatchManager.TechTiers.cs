...
namespace StrategyCore
{
    ...
    //
    // Эффекты узлов — КОНТЕНТОМ (не здесь): юниты/умения — contentUnlockRules по OnTechUnlock
    // (RecomputeUnlockedContent); герой — резолвом heroUnlockTech/heroPrefab при покупке варианта-героя.
