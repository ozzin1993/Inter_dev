...
namespace StrategyCore
{
    public class Cheats
    {
        ...
        {
            if (GameManager.instance.camera_TopDown.edgeMoveSensitivity == 0)
                GameManager.instance.camera_TopDown.edgeMoveSensitivity = 0.7f;
            else 
                GameManager.instance.camera_TopDown.edgeMoveSensitivity = 0;
        }
