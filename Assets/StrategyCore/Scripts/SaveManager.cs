...
namespace StrategyCore
{
    ...
    public class SaveManager : MonoBehaviour
    {
        ...
        public static string SaveToFile(bool returnData = false)
        {
            ...
            if (!returnData)
            {
                if (UIManagerMenu.instance) UIManagerMenu.instance.ShowMenuLobby(2);
                Time.timeScale = 0f;
            }
            ...
            if (UIManagerMenu.instance) UIManagerMenu.instance.ShowMenuLobby(4);
        ...
        public static bool LoadSlotManagerData(string fileName, bool isPath = false)
        {
            ...
            if (File.Exists(fileName))
            {
                ...
                UIManagerMenu.instance.FillPlayerList(); // Refresh
